...
const morgan = require('@appetism/binant-codetest-shared/src/config/morgan');
const { errorConverter, errorHandler } = require('@appetism/binant-codetest-shared/src/middlewares/error');
